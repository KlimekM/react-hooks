...
This lesson was quite useful in providing some helpful reminders. In particular
lazy state initialization is something I rarely think about, but was a fun piece
to play around with by setting console.logs and cemented the idea. I peeked a
bit at the 4th extra credit for the flexible localStorage hook to consider some
of the edge cases which the video cleared up.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=02%3A%20useEffect%3A%20persistent%20state&em=mklimek15%40gmail.com).
